                ...
                >
                    <div class="row">
                        <div class="col-12 text-center">
                            <h4 class="font-weight-bold text-g-yellow">{{ paquetesTitulo }}</h4>
                            <p class="font-weight-bold">{{ paquetesDuracion }} days</p>
                        ...
                        <div class="col-6">
                            <el-form-item prop="pasajeros">
                                <el-input placeholder="Travelers" size="small" type="number" v-model="ruleForm.pasajeros"></el-input>
                            </el-form-item>
                        </div>
                        <div class="col-12">
...
<script>
export default {
    props: ['paquetesTitulo','paquetesDuracion'],
    data() {
        return {
            ruleForm: {
                options_plan: [
